...
import { parseMenuStructure, createMenuStructure } from '../api/menu-structure.api'
import { ParsedMenuStructure, CreateMenuStructureRequest } from '../types/menu-structure.types'
...
// Parse menu structure from image
