import { CreateRestaurantCommand, CreateRestaurantResult, GetUserRestaurantsResult, GetUserRestaurantsParams, ApiResponse, ResponseData } from '../types'
...
export const restaurantApi = {
  ...
  getUserRestaurants: async (params?: GetUserRestaurantsParams): Promise<ResponseData<GetUserRestaurantsResult>> => {
    ...
    const { data: response } = await apiClient.get<ApiResponse<GetUserRestaurantsResult>>('/api/restaurants/user', { params: queryParams })
