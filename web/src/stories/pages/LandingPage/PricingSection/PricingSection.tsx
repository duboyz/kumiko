...
export function PricingSection({}: PricingSectionProps) {
  ...
  return (
    <div
      ref={sectionRef}
      className={`py-24 px-8 bg-gradient-to-b from-blue-50 to-white ${bebasNeue.className}`}
    >
        ...
        <div className="mt-20 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="text-left">
              ...
              <p className="text-gray-600 text-sm">Yes, you can upgrade or downgrade your plan at any time with no penalties.</p>
            </div>
            <div className="text-left">
