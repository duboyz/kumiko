    ...
    <section className={`relative py-12 px-4 md:px-6 lg:px-8 ${className}`}>
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-8">
          ...
          {restaurantMenu.description && <p className="text-lg text-gray-600">{restaurantMenu.description}</p>}
        </div>
                      ...
                      >
                        <div className="flex-1">
                          <div className="flex items-start justify-between">
                            <div className="flex-1">
                              <h4 className="text-lg font-medium text-gray-900">{categoryItem.menuItem?.name}</h4>
                              {categoryItem.menuItem?.description && (
                                <p className="text-gray-600 mt-1 text-sm">{categoryItem.menuItem.description}</p>
                              )}
