...
const meta: Meta<typeof SimpleUploadStep> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'Simple upload step component for menu import flow. Allows users to upload menu images via drag-and-drop, file selection, or camera capture. Provides image preview and file validation.',
      },
    },
  },
  tags: ['autodocs'],
