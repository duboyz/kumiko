...
export const LongDescription: Story = {
  args: {
    category: {
      ...
      description:
        'Our premium selection features the finest ingredients sourced from local farms and prepared with traditional techniques passed down through generations',
    },
  },
}
