import { HeroSectionType, HeroSectionDto } from '@shared'
import { HeroSection } from './index'
import type { Meta, StoryObj } from '@storybook/nextjs-vite'
import { useState } from 'react'

// Wrapper component for editable story with state management
const EditableHeroWrapper = (args: { section: HeroSectionDto; isEditing?: boolean }) => {
  const [state, setState] = useState(args.section)
  ...
  return (
    <HeroSection section={state} isEditing={args.isEditing} onUpdate={handleUpdate} onTypeChange={handleTypeChange} />
  )
}

const meta = {
  title: 'Websites/HeroSection',
