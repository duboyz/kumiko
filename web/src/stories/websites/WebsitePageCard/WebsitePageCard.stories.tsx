...
const mockPageWithSections: WebsitePageDto = {
  ...
  sections: [
    ...
    },
    {
      ...
      sortOrder: 1,
      websitePageId: '1',
      restaurantMenuSection: { id: 'm1', restaurantMenuId: 'menu1', allowOrdering: false },
    },
    {
      id: '3',
      sortOrder: 2,
      websitePageId: '1',
      textSection: { id: 't1', title: 'About Us', text: 'Our story', alignText: TextAlignment.Left },
    },
  ],
}
  ...
  sections: [
    {
      ...
      sortOrder: 0,
      websitePageId: '3',
      textSection: { id: 't1', title: 'Get in Touch', text: 'Get in touch', alignText: TextAlignment.Center },
    },
  ],
}
...
const mockPageLongTitle: WebsitePageDto = {
  ...
  sections: [
    ...
    },
    {
      ...
      sortOrder: 1,
      websitePageId: '4',
      textSection: { id: 't1', title: 'Event Gallery', text: 'Photos', alignText: TextAlignment.Left },
    },
    {
      id: '3',
      sortOrder: 2,
      websitePageId: '4',
      textSection: { id: 't2', title: 'Reservations', text: 'Book now', alignText: TextAlignment.Center },
    },
    {
      id: '4',
      sortOrder: 3,
      websitePageId: '4',
      textSection: { id: 't3', title: 'Testimonials', text: 'Reviews', alignText: TextAlignment.Left },
    },
    {
      id: '5',
      sortOrder: 4,
      websitePageId: '4',
      textSection: { id: 't4', title: 'FAQ', text: 'Questions', alignText: TextAlignment.Left },
    },
  ],
}
