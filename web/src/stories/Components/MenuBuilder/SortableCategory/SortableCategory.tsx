...
import { MenuCategoryDto, MenuItemDto, CreateMenuItemCommand } from '@shared'
import { SortableMenuItem } from '@/components'
import { AddItemPopover } from '@/components'
import { AddExistingItemForm, AddNewItemForm } from '@/components'
      ...
      <CardHeader className="pb-3">
        <div className="flex items-center justify-between">
          ...
          <div className="flex gap-2">
            {editingCategory === category.id ? (
              <Button variant="outline" size="sm" onClick={() => onUpdateCategory(category.id, {})}>
