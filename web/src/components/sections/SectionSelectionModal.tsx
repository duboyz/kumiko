...
export function SectionSelectionModal({ open, onOpenChange, onSelectSection, hasMenusAvailable = false, isLoadingMenus = false }: SectionSelectionModalProps) {
      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 py-4">
          {sectionTypes.map((sectionType) => (
            <Card
              key={sectionType.id}
              className={`cursor-pointer transition-all hover:shadow-md ${!sectionType.available
