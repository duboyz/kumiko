  ...
  return (
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">Review your image and process it with AI to extract menu items</p>
      </div>
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Your image looks good! Click below to extract menu items using AI.
                </p>
