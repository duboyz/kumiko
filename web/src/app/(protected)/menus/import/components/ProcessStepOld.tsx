  ...
  const handleProcess = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        const itemsWithConfidence = result.menuItems.map((item: any, index: number) => ({
          id: `temp-${index}`,
        ...
        if (errorData.error?.includes('No text detected')) {
          ...
          errorMsg = 'No menu items found. Please ensure the image contains a menu.'
        } else {
      ...
      if (!errorMessage) {
        onError(`Failed to upload and parse menu: ${error instanceof Error ? error.message : 'Unknown error'}`)
      }
    } finally {
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          AI will analyze your annotated menu to extract menu items and categories
        </p>
      </div>
      ...
      {imagePreview && (
        <div className="relative">
          <img src={imagePreview} alt="Menu preview" className="w-full h-64 object-cover rounded-lg border" />
        ...
        <Card>
          <CardContent className="p-8 text-center">
            <div className="space-y-4">
              ...
              <div>
                <h3 className="text-lg font-semibold mb-2">{processingStep || 'AI is analyzing your menu...'}</h3>
            ...
            <div className="text-center space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground mb-4">
                  Your annotated menu is ready! Click below to extract menu items using AI.
                </p>
                {annotations.length > 0 && (
                  <p className="text-sm text-green-600 mb-4">
                    ✓ {annotations.length} annotations will help AI understand your menu structure
                  </p>
                )}
