...
export function AnnotationStep({
  ...
  const [selectedType, setSelectedType] =
    useState<Annotation["type"]>("category");
  ...
  const [tool, setTool] = useState<"rectangle" | "circle" | "highlight">(
    "rectangle",
  );
    ...
    <div className="space-y-6">
      <div className="text-center">
        ...
        <p className="text-muted-foreground">
          Mark categories, items, and prices with different colors to help AI
        ...
        <div className="text-xs text-muted-foreground mt-2">
          ...
          <kbd className="px-1 py-0.5 bg-gray-200 rounded text-xs">Shift</kbd> +
            ...
            <CardContent className="p-4">
              <div className="relative border rounded-lg overflow-hidden bg-gray-50">
                ...
                >
                  <Layer>
                    ...
                    {annotations.map((annotation) => {
                      const typeConfig = ANNOTATION_TYPES.find(
                        (t) => t.type === annotation.type,
                      );
                      ...
                      if (tool === "circle") {
                        return (
                          <KonvaCircle
                            ...
                            radius={
                              Math.max(annotation.width, annotation.height) / 2
                            }
                ...
                <div className="absolute bottom-2 left-2 bg-black/70 text-white px-2 py-1 rounded text-xs">
                  ...
                  {selectedAnnotationId &&
                    " • Click to select • Drag handles to resize • Delete key to remove"}
                </div>
              </div>
            </CardContent>
          </Card>
