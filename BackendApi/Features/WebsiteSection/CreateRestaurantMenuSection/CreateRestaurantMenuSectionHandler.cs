...
public class CreateRestaurantMenuSectionHandler(
    ...
    IHttpContextAccessor httpContextAccessor) : ICommandHandler<CreateRestaurantMenuSectionCommand, CreateRestaurantMenuSectionResult>
{
    public async Task<CreateRestaurantMenuSectionResult> Handle(CreateRestaurantMenuSectionCommand request, CancellationToken cancellationToken)
    {
        ...
        var restaurantMenuSection = new RestaurantMenuSection
        {
        ...
        section.RestaurantMenuSection = restaurantMenuSection;

        await websiteSectionRepository.AddAsync(section);

        return new CreateRestaurantMenuSectionResult(section.Id, restaurantMenuSection.Id);
    }
}